...
describe('PropertyWrapper Edge Cases', function (): void {
    ...
    it('can get property default value when available', function (): void {
        $properties = $this->classWrapper->getAllProperties(protected: true, private: true);
    ...
    it('can check if property is initialized', function (): void {
        $properties = $this->classWrapper->getAllProperties(protected: true, private: true);
    ...
    it('can get property modifiers', function (): void {
        $properties = $this->classWrapper->getAllProperties(protected: true, private: true);
    ...
    it('detects if property has hooks (PHP 8.4)', function (): void {
        $properties = $this->classWrapper->getAllProperties(protected: true, private: true);
    ...
    it('can get property declaring class', function (): void {
        $properties = $this->classWrapper->getAllProperties(protected: true, private: true);
    ...
    it('can set and get property value via reflection', function (): void {
        $properties = $this->classWrapper->getAllProperties(protected: true, private: true);
        $collector = new ErrorCollector;
    ...
    it('detects if property is internal', function (): void {
        $properties = $this->classWrapper->getAllProperties(protected: true, private: true);
    ...
    it('can check if property is deprecated', function (): void {
        $properties = $this->classWrapper->getAllProperties(protected: true, private: true);
