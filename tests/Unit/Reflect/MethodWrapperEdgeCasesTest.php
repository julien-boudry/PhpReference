...
describe('MethodWrapper Edge Cases', function () {
    ...
    it('detects methods with reference parameters', function () {
        $methods = $this->classWrapper->getAllUserDefinedMethods();
    ...
    it('can get method closure', function () {
    ...
    it('can check if method is generator', function () {
        $methods = $this->classWrapper->getAllUserDefinedMethods();
    ...
    it('can get method prototype if exists', function () {
        $methods = $this->classWrapper->getAllUserDefinedMethods();
    ...
    it('can check if method is deprecated', function () {
        $methods = $this->classWrapper->getAllUserDefinedMethods();
    ...
    it('can get method modifiers', function () {
        $method = $this->classWrapper->methods['addWarning'];
    ...
    it('detects internal methods', function () {
        $methods = $this->classWrapper->getAllUserDefinedMethods();
    ...
    it('can get method start and end line', function () {
        $method = $this->classWrapper->methods['addWarning'];
    ...
    it('can invoke method with reflection', function () {
        $method = $this->classWrapper->methods['addWarning'];
        $collector = new ErrorCollector();
