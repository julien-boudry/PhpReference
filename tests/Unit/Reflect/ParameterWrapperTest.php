...
describe('ParameterWrapper', function () {
    beforeEach(function () {
    ...
    it('wraps a parameter correctly', function () {
    ...
    it('detects parameter type', function () {
        $param = $this->params[0] ?? null;
    ...
    it('detects if parameter has default value', function () {
    ...
    it('gets default value when available', function () {
        $contextParam = $this->params[1] ?? null;
    ...
    it('detects if parameter is passed by reference', function () {
        $param = $this->params[0] ?? null;
    ...
    it('gets parameter position', function () {
        $messageParam = $this->params[0] ?? null;
        $contextParam = $this->params[1] ?? null;
    ...
    it('detects nullable parameters', function () {
        $contextParam = $this->params[1] ?? null;
