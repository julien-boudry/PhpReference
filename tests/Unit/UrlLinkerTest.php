...
describe('UrlLinker', function () {
    it('can be created with a writable source page', function () {
    ...
    it('generates correct relative link from root to root', function () {
    ...
    it('generates correct relative link from deep path to root', function () {
        $source = new class implements \JulienBoudry\PhpReference\Reflect\Capabilities\WritableInterface {
            public function getPageDirectory(): string { return '/ref/Namespace/Class'; }
            public function getPagePath(): string { return '/ref/Namespace/Class/method.md'; }
            public function getUrlLinker(): UrlLinker { return new UrlLinker($this); }
        };
    ...
    it('generates correct relative link between sibling pages', function () {
        ...
        $source = new class implements \JulienBoudry\PhpReference\Reflect\Capabilities\WritableInterface {
            public function getPageDirectory(): string { return '/ref/Namespace/ClassA'; }
            public function getPagePath(): string { return '/ref/Namespace/ClassA/ClassA.md'; }
            public function getUrlLinker(): UrlLinker { return new UrlLinker($this); }
        };

        $dest = new class implements \JulienBoudry\PhpReference\Reflect\Capabilities\WritableInterface {
            public function getPageDirectory(): string { return '/ref/Namespace/ClassB'; }
            public function getPagePath(): string { return '/ref/Namespace/ClassB/ClassB.md'; }
            public function getUrlLinker(): UrlLinker { return new UrlLinker($this); }
        };
